  ...
  export default {
    ...
    methods: {
      ...
      publish: function (event, rows) {
        ...
        axios.get('/sanctum/csrf-cookie').then((response) => {
          axios
            .post('/api/tumblr/cats-video-tumblr-publish', { selRows: self.selectedItemsEmitted })
            .then((response) => {
              if (response.status) {
                console.log('Вызвали алерт')
      ...
      createAdvertPost: function (event, rows) {
        ...
        axios.get('/sanctum/csrf-cookie').then((response) => {
          axios
            .post('/api/tumblr/cats-advert-video-tumblr-publish', { selRows: self.selectedItemsEmitted })
            .then((response) => {
              if (response.status) {
                console.log('Вызвали алерт')
                this.$vaToast.init({ message: 'Запись добавлена в телеграмм', color: 'success' })
