    ...
    methods: {
      ...
      fetchRows() {
        ...
        axios
          .request({
            method: 'post',
            url: '/api/tumblr/nature-photo-all',
      ...
      publish: function (event, rows) {
        ...
        axios.get('/sanctum/csrf-cookie').then((response) => {
          axios
            .post('/api/tumblr/anime-photo-tumblr-publish', { selRows: self.selectedItemsEmitted })
            .then((response) => {
              if (response.status) {
                console.log('Вызвали алерт')
      ...
      createAdvertPost: function (event, rows) {
        ...
        axios.get('/sanctum/csrf-cookie').then((response) => {
          axios
            .post('/api/tumblr/anime-advert-photo-tumblr-publish', { selRows: self.selectedItemsEmitted })
            .then((response) => {
              if (response.status) {
                console.log('Вызвали алерт')
                this.$vaToast.init({ message: 'Запись добавлена в телеграмм', color: 'success' })
