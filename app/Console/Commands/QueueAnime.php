...
class QueueAnime extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:publish-anime-queue';
     ...
     * @var string
     */
    protected $description = 'Публикация постов в категорию Аниме из очереди';
            ...
            if (!empty($messageText)) {
                ...
                foreach ($list_img as $img) {
                    foreach ($img as $item_image) {
                        ...
                        $media->addItem(new InputMediaPhoto($item_image, $messageText));
                    }
                }
